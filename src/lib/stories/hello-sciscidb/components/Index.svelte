...
<section class="sciscidb-story story">
	<div class="dashboard">
		<Header />
		...
		<div class="content-wrapper">
			<div class="text-content">
				<p>As part of their snapshot, they provide 16M parsed texts, called the <a href="https://github.com/allenai/s2orc">s2orc</a> collection, facilitating the creation of downstream applications such as <a href="https://www.connectedpapers.com/">Connected Papers</a>. Their original parsing scheme built on top of Grobid was made available on <a href="https://github.com/allenai/s2orc-doc2json">GitHub</a>. From that parsing, they extract a 2.4B citation graph that connects and contextualizes all that information.</p>
			...
			<figure class="image-container">
				<img src="{base}/paper_layers.jpg" alt="PaperMage paper layers" width="300" />
		...
		<div class="chart-container">
			<Streamgraph data={stemFiltered} offset={selectedOffset} {clicked} />
		</div>
		...
		<div class="chart-container">
			<Streamgraph data={socSciFiltered} offset={selectedOffset} {clicked} />
		</div>
...
<style>
	...
	.dashboard p {
		line-height: 1.6;
		font-size: 1.1rem;
		font-family: var(--vcsi-font-sans, sans-serif);
		max-width: none;
	}
